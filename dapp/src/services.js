...
import blocknativeIcon from './icons/icon.png'
...
const social_network = sequenceModule()
...
export const initWeb3Onboard = init({
  ...
  appMetadata: {
    ...
    description: 'This is your wallet! Dont worry is just an ID that will manage your assets ',
  ...
  i18n: {
    es: {
      connect: {
        selectingWallet: {
          header: 'Log in with the following methods!',
          sidebar: {
            heading: 'Comenzar',
            subheading: 'Get Started!',
            paragraph:
              'Choose Sequence to start using your Google, Facebook Twitter or other Social Account!'
          }
        }
      },
      accountCenter: {
